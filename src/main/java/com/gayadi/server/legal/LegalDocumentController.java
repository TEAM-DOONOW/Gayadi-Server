...
public class LegalDocumentController {
    ...
    public LegalDocumentController(LegalDocumentService service, ApiResponseMapper mapper) {
    ...
    @ApiResponse(responseCode = "200", description = "현재 공개 중인 법률 문서입니다.",
            content = @Content(schema = @Schema(implementation = ApiResponses.LegalDocument.class)))
    public ApiResponses.LegalDocument legalDocument(@PathVariable String documentId) {
        return mapper.toDto(service.get(documentId), ApiResponses.LegalDocument.class);
    }
}
