...
/** TourAPI 후보를 일정에서 재사용할 수 있는 공개 장소 스냅숏으로 저장합니다. */
@Repository
public class PlaceSnapshotRepository implements PlaceSnapshotWriter {

    private final JdbcClient jdbc;
    private final KeyHelper keyHelper;

    public PlaceSnapshotRepository(JdbcClient jdbc, KeyHelper keyHelper) {
        this.jdbc = jdbc;
        this.keyHelper = keyHelper;
    }

    /** 장소 스냅숏 장소 스냅숏 데이터를 DB에 저장합니다. */
    @Override
    @Transactional
