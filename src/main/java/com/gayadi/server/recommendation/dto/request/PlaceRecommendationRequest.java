package com.gayadi.server.recommendation.dto.request;
...
public class PlaceRecommendationRequest {
    ...
    public void setSituation(TravelSituation situation) {
        this.situation = situation;
    }

    public boolean isExternalProcessingConsent() {
        return externalProcessingConsent;
    }
