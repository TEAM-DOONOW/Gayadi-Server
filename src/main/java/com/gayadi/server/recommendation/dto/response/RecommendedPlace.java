...
public record RecommendedPlace(
        ...
        @Schema(description = "장소명", example = "국립중앙박물관")
        String name,

        @Schema(description = "정규화된 장소 분류", example = "CULTURE")
        String category,

        @Schema(description = "추천 점수(0~1)", minimum = "0", maximum = "1", example = "0.91")
        double score,

        @Schema(description = "추천 이유")
        String reason,

        @Schema(description = "TourAPI 원본 콘텐츠 ID", example = "126508")
